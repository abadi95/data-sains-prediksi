...
lottie_animation_url = "https://lottie.host/0b7b4cc2-19cd-4bc3-9805-241250c7baed/o0NRHFHGm2.json"
...
with st.expander ("Buat prediksi", expanded=True):
    ...
    transferred = st.radio (label="Pilih apakah hari libur dipindahkan atau tidak", options=[ "True", "False"], horizontal=True)
    onpromotion = st.number_input(
        label="Silakan masukkan jumlah total item yang diharapkan ada pada promosi")
